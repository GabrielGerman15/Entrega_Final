...
public class Main {
    private static String emailAddress;
        ...
        private static void showMainMenu() {
            ...
            try {
                //Ejemplo de select y conexión a la BD.
                //Llamamos al método conectar() y hacemos un select
                test.conectar();
                try (PreparedStatement stmt = test.getConexion().prepareStatement("SELECT id_empleado, nombre, apellido FROM empleado")) {
                    ResultSet rs = stmt.executeQuery();
                    //Recorremos el resulset (rs) e imprimimos en pantalla los resultados
                    while (rs.next()) {
